...
In a previous example, the [Illusion Ability Example](https://iwasinminedream.github.io/moddota.github.io/forums/discussion/62/illusion-ability-example) made use of the `"modifier_illusion modifier"` in Lua like this:
...
The fields between { } are **Very** specific. For that particular modifier, I took the values from [this magic list](https://iwasinminedream.github.io/moddota.github.io/resources/modifier_keys.txt), but this isn't the only way of acquiring them, as this list is very incomplete.
